...
describe("test the strategy matchers", () => {
  ...
  function equals(
    ...
    expect(matcher.findMatcher(rsa).match(suppliedVal, rsa)).toBe(matches);
  }

  it("percentage rollout is consistent", () => {
    const base = new Murmur3PercentageCalculator().determineClientPercentage("irina", "one");
    for (let count = 0; count < 5; count++) {
      expect(new Murmur3PercentageCalculator().determineClientPercentage("irina", "one")).toBe(
        base,
      );
    }
  });
  ...
  it("ip address matcher", () => {
    ...
    equals(
      RolloutStrategyAttributeConditional.NotEquals,
      ["192.168.86.75"],
      "192.168.86.75",
      false,
    );
  ...
  it("date matcher", () => {
    ...
    equals(
      RolloutStrategyAttributeConditional.Equals,
      [new Date("2019-01-01"), new Date("2019-02-01")],
      "2019-02-01",
      true,
    );
    equals(
    ...
    equals(
      RolloutStrategyAttributeConditional.GreaterEquals,
      ["2019-01-01", "2019-02-01"],
      "2019-02-07",
      true,
    );
    ...
    equals(
      RolloutStrategyAttributeConditional.LessEquals,
      ["2019-01-01", "2019-02-01"],
      "2019-02-01",
      true,
    );
  ...
  it("datetime matcher", () => {
    ...
    equals(
      RolloutStrategyAttributeConditional.Equals,
      ["2019-01-01T01:01:01Z", "2019-02-01T01:01:01Z"],
      "2019-02-01T01:01:01Z",
      true,
    );
    equals(
      RolloutStrategyAttributeConditional.Includes,
    ...
    equals(
      RolloutStrategyAttributeConditional.Regex,
      ["2019-.*", "(.*)-03-(.*)"],
      "2019-07-06T01:01:01Z",
      true,
    );
    equals(
      RolloutStrategyAttributeConditional.Regex,
      ["2019-.*", "(.*)-03-(.*)"],
      "2014-03-06T01:01:01Z",
      true,
    );

    equals(
      RolloutStrategyAttributeConditional.StartsWith,
      ["2019", "2017"],
      "2017-03-06T01:01:01Z",
      true,
    );
    ...
    equals(
      RolloutStrategyAttributeConditional.EndsWith,
      ["03", "2017", "01:01"],
      "2017-03-06T01:01:01Z",
      false,
    );
