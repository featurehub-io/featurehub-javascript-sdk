...
describe("Google analytics collector should output correct info", () => {
  it("we should provide all different types of features and the analytics should log all except JSON", async () => {
    ...
    const features = [
      ...
      { id: "2", key: "pear", version: 1, type: FeatureValueType.Number, value: 12.3 },
      { id: "3", key: "peach", version: 1, type: FeatureValueType.String, value: "golden" },
      {
        id: "4",
        key: "cherimoya",
        version: 1,
    ...
    expect(postedData).to
      .eq(`v=1&tid=UA-123&cid=cid&t=event&ec=FeatureHub%20Event&ea=action&el=banana%20:%20on
